...
I wrote this because making intern schedules by hand is a nightmare and error prone. it's a simple Java tool that tries to distribute night shifts (gardes) and day duties (HDJ) as fairly as possible so nobody ends up with a burnout.
